      ...
      <tr className="bg-white border-b border-gray6 last:border-0 text-start mx-9">
        ...
        <td className="px-3 py-3 text-end">
          <span
            ...
            } px-3 py-1 rounded-md leading-none bg-success/10 font-medium text-end`}
          >
            {product.status}
          </span>
        </td>
        <td className="px-9 py-3 text-end">
          <div className="flex items-center justify-end space-x-2">
            <Link
              ...
              className="leading-10 text-tiny bg-success text-white rounded-md hover:bg-green-600 flex justify-center items-center w-10 h-10"
            >
              <svg
            ...
            <button
              onClick={handleOpen}
              className="w-10 h-10 flex justify-center items-center leading-[33px] text-tiny bg-white border border-gray text-slate-600 rounded-md hover:bg-danger hover:border-danger hover:text-white"
            >
              <svg
                className="-translate-y-px"
                width="14"
